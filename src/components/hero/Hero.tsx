...
const Hero = () => {
  return (
    <section className="py-5">
      <div className="container custom-screen flex flex-col px-6 py-4 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center">
        <div className="flex flex-col items-center w-full lg:flex-row lg:w-1/2">
          <div className="max-w-lg lg:mx-12 lg:order-2">
            ...
            <div className="mt-6 space-x-3">
              ...
              <Link href='/about' className="px-6 py-2.5 text-sm font-medium leading-5 text-center text-white capitalize bg-blue-600 rounded-lg hover:bg-blue-500 lg:mx-0 lg:w-auto focus:outline-none"> (206) 446-7203 </Link>
            </div>
          </div>
        </div>
